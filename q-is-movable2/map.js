...
// %%=start
{
	"map": [
		...
		[1,1,1,1,'F','E','D',1,1,1,1,1],
		[1,1,1,1,0,'C',0,1,1,1,1,1],
	...
	"links": {
		...
		"previous": "",
		"next": "",
		"genurl": "https://kondoumasaki.github.io/create-robot-mondai/q-is-movable2/render.html"
	},
	"useMapPreProcess": true,
	"preProcessDescriptions": [
		{ "c": 'A', "d": 'パターン 1 なら 0、パターン 2 なら 1、パターン 3 なら 1' },
		{ "c": 'B', "d": 'パターン 1 なら 1、パターン 2 なら 0、パターン 3 なら 1' },
		{ "c": 'C', "d": 'パターン 1 なら 1、パターン 2 なら 1、パターン 3 なら 0' },
		{ "c": 'D', "d": 'パターン 1 なら 1、パターン 2 なら 0、パターン 3 なら 0' },
		{ "c": 'E', "d": 'パターン 1 なら 0、パターン 2 なら 1、パターン 3 なら 0' },
		{ "c": 'F', "d": 'パターン 1 なら 0、パターン 2 なら 0、パターン 3 なら 1' },
	],	// [ { "c": char, "d": str }, ... ]
	"robot": {
		"type": 2,
		"Basic": {
